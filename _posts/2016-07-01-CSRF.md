...
下面我将用几个例子详细说说具体的CSRF攻击，这里我以一个银行转账的操作作为例子（仅仅是例子，真实的银行网站没这么傻:>）
...
1. 服务端进行CSRF防御
服务端的CSRF方式方法很多样，但总的思想都是一致的，就是在客户端页面<span class="red">增加伪随机数</span>。
...
[原文出处](http://www.cnblogs.com/hyddd/archive/2009/04/09/1432744.html)